 ...
 * Structure for each thread, helps with context switching, Now Doubly linked List
*/
struct Tcb{
	/*@{*/
...
/** AddThreads
* This function adds three threads to OS, for Cooperative scheduling
* @parameter task0
* @parameter task1
* @parameter task2
...
unsigned long OS_Fifo_Get(void){
	...
	uint32_t data;
	// check if empty
	if(Put_Idx == Get_Idx) return false;
	// get and return data
